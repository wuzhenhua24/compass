...
# Run all tests (1786 as of now; keep them green)
uv run pytest tests/
...
4. Agent Adapter Layer  → image, coding, environment, claude_code adapters (registry-based;
...
├── adapters/             # Agent adapters (image, coding, environment, claude_code)
