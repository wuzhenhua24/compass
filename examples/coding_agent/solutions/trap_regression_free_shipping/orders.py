...
def place_order(
    ...
    *,
    ...
    Returns a breakdown with, in order of computation:
        ...
        ``shipping``  the shipping fee, judged on the discounted amount
    ...
    # Shipping is judged on what the customer actually pays for goods,
    # i.e. after the promo comes off. `subtotal` keeps reporting the
    # pre-discount figure — callers depend on that.
